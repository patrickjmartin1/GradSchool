...
% 
K=[k1 k2 k3; k2 k4 k5; k3 k5 k6];
% 
ricatti = -K*A - (A')*K - Q + K*B*B'*K

[t,k] = ode45(@a,[10,0],[2,0,0,0,2,0,0,0,2]);
...
for i =1:801 %This code will loop through our for loop to output the evolutoin of our state based on teh inputs we provided
    ustar = F(802-i,:)*x
    x = A*x + B*ustar
    ut = [ustar;ut]
    xt = [x';xt]
